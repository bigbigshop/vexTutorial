...
title: 5.6 狀態機(FSM)
sidebar_position: 6
description: 引入軟體工程核心概念「有限狀態機 (FSM)」，學習如何優化 VEX V5 的複雜控制邏輯，解決 if-else 嵌套問題，實現如自動吸取、夾持等高階功能。
keywords: [VEX 狀態機, FSM 教學, 有限狀態機, 機械人控制邏輯, 軟體工程, VEX V5 進階編程, 邏輯簡化]
slug: /push-back/programming-fsm
---
